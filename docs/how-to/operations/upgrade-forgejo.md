...
| **`${{ forgejo.ref }}` in scheduled workflows** ([PR 13081](https://codeberg.org/forgejo/forgejo/pulls/13081)) | No action: neither scheduled workflow here (`branch-cleanup`, `horkos-forge-drift`) reads `github.ref`. |
